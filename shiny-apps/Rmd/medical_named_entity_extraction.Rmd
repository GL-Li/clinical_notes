...
For comparison, we also listed top 10 words having the highest term frequency (top_tf) and term frequency inverse document frequency (top_tfidf) in the table. 
